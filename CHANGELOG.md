...
* Require the exactly matching `cbor2-derive` release. Code generated by
  cbor2-derive 1.1.5 calls runtime entry points that cbor2 1.1.4 lacks, a
  combination the previous `^1` requirement allowed.
